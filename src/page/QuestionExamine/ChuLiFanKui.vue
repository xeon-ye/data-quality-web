    ...
    <el-form ref="ruleForm" label-width="100px" class="demo-ruleForm">
      <el-card class="box-card" shadow="never">
        ...
        <div class="qa-body">
          ...
          <el-upload :key="ROWDATA&&ROWDATA.id" action="#" list-type="picture-card" :file-list="fileList" class="preview">
...
export default {
  ...
  computed: {
    ...
    ROWDATA: function() {
      let ROWDATA = this.$store.state.fankuishenghe.FANKUIROWDATA;
      let fileList = [];
      if (ROWDATA && ROWDATA.images)
        fileList = ROWDATA.images.map(
